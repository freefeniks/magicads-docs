...
description: 'Let your users bring in new customers and earn along with you with the help of Referral System integrated into Davinci AI'
---
...
<Warning>Make sure that you have properly configured SMTP settings in the Davinci AI's Admin panel, otherwise your users will not be able to send invites</Warning>
...
Davinci AI also allows your users to change their **Referral IDs** to a custom ones, and then share it accordingly with their friends. 
