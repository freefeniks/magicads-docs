...
<Warning>This is a **Paid** plugin (slug: `magicads-avatar-studio`) that you need to first purchase and install via the in-app **Plugins** marketplace. Some plugins are free for **Extended License** holders.</Warning>
