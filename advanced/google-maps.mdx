...
<Steps>
  ...
  <Step title="Step 3">
   ...
   <img src="/images/advanced/maps/google-maps-1.jpg" />
  </Step>
   <Step title="Step 4">
  ...
  <Step title="Step 5">
     Find **Maps JavaScript API** and enable it as shown below.
      <img src="/images/advanced/maps/google-maps-2.jpg" />
  </Step>
  <Step title="Step 6">
     Click the menu button and select **Credentials** and click **Create credentials** -> **API key**.
     <img src="/images/advanced/maps/google-maps-3.jpg" />
  </Step>
  <Step title="Step 7">
     The **API key created** dialog displays your newly created API key, copy it. The new API key is listed on the Credentials page under API keys.
      <img src="/images/advanced/maps/google-maps-4.jpg" />
  </Step>
   <Step title="Step 8">
