...
description: 'Essential steps to configure your Magic Ads installation for optimal performance and functionality.'
---
...
```
This command runs the Laravel schedule command in your Magic Ads installation directory every minute.

<Note>Replace `/path/to/app/root/` with the actual path to your Magic Ads application’s root directory.</Note>
...
<Steps>
  ...
  */5 * * * * /usr/local/bin/php /home/username/YOURDOMAINPATH/artisan schedule:run
  ...
  <Step title="Step 6">
    <Check>You have successfully configured the CRON via Cpanel for Magic Ads</Check>
  </Step>
</Steps> 
