...
sidebarTitle: "SMTP"
description: 'Configure your SMTP settings for sending outgoing emails form Davinci AI, such as email verification, support ticket creation, payment statuses etc'
---
...
<Steps>
  <Step title="Step 1">
    Go to **Admin Panel** -> **General Settings** -> **SMTP Settings** page.     
  </Step>
  <Step title="Step 2">
...
<br />
  ...
  <Step title="Step 5">
    <Check>Congratulations! You have successfully configured the SMTP settings for Davinci AI</Check>
  </Step>
</Steps>